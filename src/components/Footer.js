...
import eastoWhiteLogo from '../assets/logo/easto-logo-tag-wh-txt-gr-bg-blr.png';
...
const Footer = () => {
  return (
    <div className="flex flex-col gap-5 pt-6 pb-6 justify-between bg-gradient-to-r from-emerald-600 to-lime-500">
      <div className="flex flex-wrap lg:flex-nowrap text-white gap-3 justify-start mx-5 lg:mx-32">
        <div className="w-full lg:w-2/3 flex flex-col gap-2 px-2 lg:items-start items-center lg:mb-0 mb-4">
          <Link to="/" className="flex flex-row gap-1 lg:mb-0 -mb-6" >
            <img src={eastoWhiteLogo} alt="logo" className="lg:max-w-52 max-w-60 -ml-4 mb-4 lg:mb-0" />
          </Link>
        ...
        <div className="w-full text-xm lg:text-md lg:w-1/4 items-center flex flex-col">
          ...
          <ul className="flex flex-row lg:flex-col gap-4 mt-3">
            <a href={process.env.REACT_APP_FACEBOOK_URL} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
              <FaFacebook />
              <span className="hidden lg:block">Facebook</span>
            </a>
            <a href={process.env.REACT_APP_INSTAGRAM_URL} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
              <FaInstagram />
              <span className="hidden lg:block">Instagram</span>
            </a>
            <a href={process.env.REACT_APP_YOUTUBE_URL} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
              <FaYoutube />
            ...
            <a href={process.env.REACT_APP_LINKEDIN_URL} target="_blank" rel="noreferrer" className="flex gap-2 items-center">
              <FaLinkedin />
      ...
      <p className="text-center text-white -mb-5">Copyright © 2025. All Rights Reserved.</p>
    </div>
  );
};
